...
public class ControlValveServiceActivity extends RuntimePermissionsActivity implements View.OnClickListener {

    private static final String TAG = ControlValveServiceActivity.class.getSimpleName();
    ...
    private void bind() {
        ...
        String[] serviceItemArray = mContext.getResources().getStringArray(R.array.control_valve_service);
    ...
    private void updateService() {
        ...
        if (picturePath != null && !picturePath.equals("")) {
         ...
         /*else {
            call = apiInterface.updateControlValvesService(Utility.getSharedPreferences(mContext, Constant.userId),
    ...
    private Uri getImageUri(Context context, Bitmap original) {
        Log.e(TAG, "getImageUri");
        ByteArrayOutputStream bytes = new ByteArrayOutputStream();
        original.compress(Bitmap.CompressFormat.JPEG, 80, bytes);
        String path = MediaStore.Images.Media.insertImage(context.getContentResolver(), original, "" + System.currentTimeMillis(), null);
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (getPickImageResultUri(data) != null) {
                    ...
                    try {
                        ...
                        Log.e(TAG, "if getPickImageResultUri =========>");
                        uri = getImageUri(mContext, myBitmap);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                } else {
                    Log.e(TAG, "else getPickImageResultUri =========>");
