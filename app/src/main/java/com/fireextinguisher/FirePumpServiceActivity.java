...
public class FirePumpServiceActivity extends RuntimePermissionsActivity implements View.OnClickListener {

    private static final String TAG = FirePumpServiceActivity.class.getSimpleName();
    ...
    String servicesSeparated = "", picturePath = "", currentPhotoPath="";
    ...
    TextInputEditText location_text1, location_text2, location_text3, location_text4, location_text5, location_text6, location_text7,
            ...
            location_text22, location_text23, location_text24, location_text25;
    ...
    TextInputEditText qty_text1, qty_text2, qty_text3, qty_text4, qty_text5, qty_text6, qty_text7, qty_text8, qty_text9, qty_text10,
            ...
            qty_text21, qty_text22, qty_text23, qty_text24, qty_text25;
    ...
    TextInputEditText remark_text1, remark_text2, remark_text3, remark_text4, remark_text5, remark_text6, remark_text7, remark_text8,
            ...
            remark_text17, remark_text18, remark_text19, remark_text20, remark_text21, remark_text22, remark_text23, remark_text24,
            remark_text25;
    ...
    TextView service_name1, service_name2, service_name3, service_name4, service_name5, service_name6, service_name7, service_name8,
            ...
            service_name17, service_name18, service_name19, service_name20, service_name21, service_name22, service_name23, service_name24,
            service_name25;

    RelativeLayout select_layout25;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fire_pump_service);
        ...
        ((TextView) toolbar.findViewById(R.id.toolbar_title)).setText("Fire Pump Service");

        PumpType = getIntent().getStringExtra(Constant.FirePump.pumpType);
        modelNo = getIntent().getStringExtra(Constant.modelNo);
        if (getIntent().getStringExtra(Constant.FirePump.spare_part_item_label) != null &&
                !getIntent().getStringExtra(Constant.FirePump.spare_part_item_label).equals("")) {
    ...
    private void bind() {
        ...
        String[] serviceItemArray;
        if (PumpType.equalsIgnoreCase("DIESEL FIRE PUMP")) {
            serviceItemArray = mContext.getResources().getStringArray(R.array.diesel_fire_pump);
        } else {
            serviceItemArray = mContext.getResources().getStringArray(R.array.electric_fire_pump);
        }
        ...
        if (oldServices.size() > 0) {
            for (int i = 0; i < serviceItemArray.length; i++) {
                ...
                findViewById(getResourceID(name, "id", mContext)).setVisibility(View.INVISIBLE);
                ...
                for (int j = 0; j < oldServices.size(); j++) {
                    if (modelArrayList.get(i).getServiceName().equalsIgnoreCase(oldServices.get(j))) {
                        ...
                        if (modelArrayList.get(i).isSelected()) {
                            ...
                            findViewById(getResourceID(empty_name, "id", mContext)).setVisibility(View.INVISIBLE);
                        }
                    }
                }
            }
    ...
    private void updateService() {
        ...
        if (picturePath != null && !picturePath.equals("")) {
            ...
            call = apiInterface.updateFirePumpWithImage(map, multipartBodyImage);
        /* else {
            call = apiInterface.updateFirePumpService(Utility.getSharedPreferences(mContext, Constant.userId),
    ...
    private void updateNonService() {
        ...
        /*} else {
            if (actualType.equals("non service")) {
                call = apiInterface.updateFirePumpNonService(
    ...
    public void bindAllEditText() {
        ...
        select_layout25 = findViewById(R.id.select_layout25);
        ...
        location_text23 = findViewById(R.id.location_text23);
        location_text24 = findViewById(R.id.location_text24);
        location_text25 = findViewById(R.id.location_text25);
        ...
        qty_text23 = findViewById(R.id.qty_text23);
        qty_text24 = findViewById(R.id.qty_text24);
        qty_text25 = findViewById(R.id.qty_text25);
        ...
        remark_text23 = findViewById(R.id.remark_text23);
        remark_text24 = findViewById(R.id.remark_text24);
        remark_text25 = findViewById(R.id.remark_text25);
        ...
        service_name23 = findViewById(R.id.service_name23);
        service_name24 = findViewById(R.id.service_name24);
        service_name25 = findViewById(R.id.service_name25);
        ...
        if (PumpType.equalsIgnoreCase("DIESEL FIRE PUMP")) {
            select_layout25.setVisibility(View.VISIBLE);
        } else {
            select_layout25.setVisibility(View.GONE);
        }
        ...
        service_name23.setOnClickListener(new ListClick(22));
        service_name24.setOnClickListener(new ListClick(23));
        service_name25.setOnClickListener(new ListClick(24));
        ...
        ((ImageView)findViewById(R.id.checkbox23)).setOnClickListener(new ListClick(22));
        ((ImageView)findViewById(R.id.checkbox24)).setOnClickListener(new ListClick(23));
        ((ImageView)findViewById(R.id.checkbox25)).setOnClickListener(new ListClick(24));
        ...
        ((ImageView)findViewById(R.id.checkbox_empty_23)).setOnClickListener(new ListClick(22));
        ((ImageView)findViewById(R.id.checkbox_empty_24)).setOnClickListener(new ListClick(23));
        ((ImageView)findViewById(R.id.checkbox_empty_25)).setOnClickListener(new ListClick(24));
        ...
        public void onClick(View v) {
            ...
            if (id == R.id.dialog_close) {
                ...
                if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    if (photoFile != null) {
                        outputFileUri = FileProvider.getUriForFile(mContext, "com.fireextinguisher.provider", photoFile);
