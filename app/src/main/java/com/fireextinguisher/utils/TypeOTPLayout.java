...
public class TypeOTPLayout extends AppCompatEditText {
    ...
    public TypeOTPLayout(Context context) {
        super(context);
    }

    public TypeOTPLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public TypeOTPLayout(Context context, AttributeSet attrs, int defStyleAttr) {
