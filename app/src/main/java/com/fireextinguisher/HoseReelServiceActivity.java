...
public class HoseReelServiceActivity extends RuntimePermissionsActivity implements View.OnClickListener {

    private static final String TAG = HoseReelServiceActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ((TextView) toolbar.findViewById(R.id.toolbar_title)).setText("Hose Reel Service");
    ...
    private void bind() {
        ...
        String[] serviceItemArray = mContext.getResources().getStringArray(R.array.hose_reel_spare_part_item);
    ...
    private void updateService() {
        ...
        if (picturePath != null && !picturePath.equals("")) {
            ...
            call = apiInterface.updateHoseReelWithImage(map, multipartBodyImage);
        /*} else {
            call = apiInterface.updateHoseReelService(Utility.getSharedPreferences(mContext, Constant.userId),
    ...
    private void updateNonService() {
        ...
        /*} else {
            if (actualType.equals("non service")) {
                call = apiInterface.updateHoseReelNonService(
