...
public class ServiceActivity extends RuntimePermissionsActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ((TextView) toolbar.findViewById(R.id.toolbar_title)).setText("Fire Extinguisher Service");

        modelNo = getIntent().getStringExtra(Constant.modelNo);
        if (getIntent().getStringExtra(Constant.ProductInfo.spare_part_item_label) != null &&
                !getIntent().getStringExtra(Constant.ProductInfo.spare_part_item_label).equals("")) {
    ...
    private void bind() {
        ...
        String[] serviceItemArray = mContext.getResources().getStringArray(R.array.service_item);
    ...
    private void updateService() {
        ...
        /*} else {
            call = apiInterface.updateFireExtinguisherService(Utility.getSharedPreferences(mContext, Constant.userId),
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (getPickImageResultUri(data) != null) {
                    ...
                    try {
                        ...
                        Log.e(TAG, "uri = outputFileUri =======> " + uri);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                } else {
