...
public class FirePumpNotServiceableActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = FirePumpNotServiceableActivity.class.getSimpleName();
    Context mContext;
    Button service_btn;
    Toolbar toolbar;
    ListView list_view;
