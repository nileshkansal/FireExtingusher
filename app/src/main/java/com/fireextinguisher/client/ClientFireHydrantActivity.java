...
public class ClientFireHydrantActivity extends RuntimePermissionsActivity implements View.OnClickListener {

    private static final String TAG = ClientFireHydrantActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client_fire_hydrant);
    ...
    private void updateClientRemark() {
        ...
        if (picturePath != null && !picturePath.equals("")) {
            ...
            call = apiInterface.clientUpdateFireHydrantWithImage(map, multipartBodyImage);
        /*}  else {
            HashMap<String, RequestBody> map = new HashMap<>();
            map.put("empId", createPartFromString(empId));
            map.put("modelNo", createPartFromString(modelNo));
            ...
            call = apiInterface.clientUpdateFireHydrant(map);
        }*/
