...
public class ClientHoseReelActivity extends RuntimePermissionsActivity implements View.OnClickListener {

    private static final String TAG = ClientHoseReelActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client_hose_reel);
    ...
    private void updateClientRemark() {
        ...
        if (picturePath != null && !picturePath.equals("")) {
            ...
            call = apiInterface.clientUpdateHoseReelWithImage(map, multipartBodyImage);
        /*}  else {
            HashMap<String, RequestBody> map = new HashMap<>();
            map.put("empId", createPartFromString(empId));
            map.put("modelNo", createPartFromString(modelNo));
            ...
            call = apiInterface.clientUpdateHoseReel(map);
        }*/
