...
import com.fireextinguisher.FirePumpInstalledActivity;
...
public class ClientFirePumpActivity extends RuntimePermissionsActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client_fire_pump);
        mContext = this;
    ...
    private void updateClientRemark() {
        ...
        if (picturePath != null &&  !picturePath.equals("")) {
            ...
            call = apiInterface.clientUpdateFirePumpWithImage(map, multipartBodyImage);
        /*}  else {
            HashMap<String, RequestBody> map = new HashMap<>();
            map.put("empId", createPartFromString(empId));
            map.put("modelNo", createPartFromString(modelNo));
            ...
            call = apiInterface.clientUpdateFirePump(map);
        }*/
