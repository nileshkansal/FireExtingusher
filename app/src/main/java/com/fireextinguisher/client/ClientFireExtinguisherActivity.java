...
public class ClientFireExtinguisherActivity extends RuntimePermissionsActivity implements View.OnClickListener {

    private static final String TAG = ClientFireExtinguisherActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client_fire_extinguisher);
    ...
    private void updateClientRemark() {
        ...
        if (picturePath != null &&  !picturePath.equals("")) {
            ...
            call = apiInterface.clientUpdateSiteModelProductWithImage(map, multipartBodyImage);
        /*}  else {
            HashMap<String, RequestBody> map = new HashMap<>();
            map.put("empId", createPartFromString(empId));
            map.put("modelNo", createPartFromString(modelNo));
            ...
            call = apiInterface.clientUpdateSiteModelProduct(map);
        }*/
