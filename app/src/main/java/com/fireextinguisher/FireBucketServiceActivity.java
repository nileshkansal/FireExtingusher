...
public class FireBucketServiceActivity extends RuntimePermissionsActivity implements View.OnClickListener {

    private static final String TAG = FireBucketServiceActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ((TextView) toolbar.findViewById(R.id.toolbar_title)).setText("Fire Bucket Service");

        modelNo = getIntent().getStringExtra(Constant.modelNo);
        if (getIntent().getStringExtra(Constant.FireBucket.spare_part_item_label) != null &&
                !getIntent().getStringExtra(Constant.FireBucket.spare_part_item_label).equals("")) {
    ...
    private void bind() {
        ...
        String[] serviceItemArray = mContext.getResources().getStringArray(R.array.fire_bucket_spare_part_item);
    ...
    private void updateService() {
        ...
        if (picturePath != null && !picturePath.equals("")) {
            ...
            call = apiInterface.updateFireBucketWithImage(map, multipartBodyImage);
        /*} else {
            call = apiInterface.updateFireBucketService(Utility.getSharedPreferences(mContext, Constant.userId),
    ...
    private void updateNonService() {
        ...
        if (picturePath != null && !picturePath.equals("")) {
         ...
         /*else {
            if (actualType.equals("non service")) {
                call = apiInterface.updateFireBucketNonService(
