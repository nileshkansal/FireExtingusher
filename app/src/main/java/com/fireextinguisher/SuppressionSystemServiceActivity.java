...
public class SuppressionSystemServiceActivity extends RuntimePermissionsActivity implements View.OnClickListener {

    private static final String TAG = SuppressionSystemServiceActivity.class.getSimpleName();
    ...
    TextInputEditText location_text1, location_text2, location_text3, location_text4, location_text5, location_text6, location_text7,
            ...
            location_text22, location_text23, location_text24;
    ...
    TextInputEditText qty_text1, qty_text2, qty_text3, qty_text4, qty_text5, qty_text6, qty_text7, qty_text8, qty_text9, qty_text10,
            ...
            qty_text21, qty_text22, qty_text23, qty_text24;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suppression_system_service);
        ...
        ((TextView) toolbar.findViewById(R.id.toolbar_title)).setText("Suppression System Service");
    ...
    private void bind() {
        ...
        String[] serviceItemArray = mContext.getResources().getStringArray(R.array.suppression_system_service);
    ...
    private void updateService() {
        ...
        if (picturePath != null && !picturePath.equals("")) {
            ...
            call = apiInterface.updateSupressionSystemWithImage(map, multipartBodyImage);
         /*else {
