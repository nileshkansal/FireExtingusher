package com.fireextinguisher.scanner.view;
...
public final class QrCodeFinderView extends RelativeLayout {
    ...
    private void drawText(Canvas canvas, Rect rect) {
        ...
        float fontTotalHeight = fontMetrics.top - fontMetrics.bottom;
        float offY = fontTotalHeight / 2 - fontMetrics.top;
        float newY = rect.top + margin + offY;
...
//            55 is an experimental value and it takes into account the scale of the screen.
        float correctedLeft = left + (60 * screenScale);
