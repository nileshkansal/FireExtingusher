package com.fireextinguisher.scanner.camera;
...
import com.fireextinguisher.scanner.utils.ScreenUtils;
...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera,  SurfaceView surfaceView) {
        ...
        mCameraResolution = findCloselySize(surfaceView.getWidth(), surfaceView.getHeight(),
                parameters.getSupportedPreviewSizes());
        Log.e(TAG, "Setting preview size: " + mCameraResolution.width + "-" + mCameraResolution.height);
        mPictureResolution = findCloselySize(surfaceView.getWidth(),
                surfaceView.getHeight(), parameters.getSupportedPictureSizes());
        Log.e(TAG, "Setting picture size: " + mPictureResolution.width + "-" + mPictureResolution.height);
